...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
    ...
    <header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
      ...
      <div class="w3-container w3-content w3-padding-64" style="max-width:800px" id="contact">
          <h3>ZRI Bank AND Bemory User Form - Best Team Ever</h3>
          <br/>
          <h4>At LOGIN - PLEASE LOGIN WITH CREDENTIALS (We Promise not to hack you) </h4>

          <!-- Add new Content Here -->
          <!-- Login -->
       <div class="w3-col m6">
         <form action="/badbanking/post-login-servlet" method="POST">
           <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
             <div class="w3-full">
               User: <input class="w3-input w3-border" type="text" placeholder="userid" required name="userid">
             </div>
             <br/>
             <div class="w3-full">
               Password: <input class="w3-input w3-border" type="password" placeholder="password" required name="password">
             </div>
           </div>
  ...
  <div class="w3-row-padding w3-grayscale">
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="/badbanking/support/images/team4.jpg" alt="Berlin" style="width:100%">
      <h3>Berlin Brown</h3>
      <p class="w3-opacity">Architect</p>
      <p>Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse sodales pellentesque elementum.</p>
      <p><button class="w3-button w3-light-grey w3-block">Contact</button></p>
