...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
    ...
    <header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
      ...
      <div class="w3-container w3-content w3-padding-64" style="max-width:800px" id="contact">
            ...
            <%
              ...
              for (final List<String> cols : dbResponse) {
               System.out.println("Size of columns  .... " + cols.size());
                 ...
                 final String message = cols.get(1);
                 final String category = cols.get(2);
                 final String email = cols.get(3);
          ...
          <form action="/badbanking/forum-home-servlet" METHOD="GET" >
           <input type="hidden" required name="action" value="FILTER">
