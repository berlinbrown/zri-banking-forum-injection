...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
    ...
    <header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
      ...
      <div class="w3-container w3-content w3-padding-64" style="max-width:800px" id="contact">
          ...
          <br/>
          <h4>At Banking and Forum Post Authentication Home Page </h4>

          <!-- Add new Content Here -->
          <a href="login.jsp">Navigate To Login</a>

          <br/><br/>
          <img src="/badbanking/support/images/winner.png" />
          <br/><br/>

          <%
           final String loginFlag = String.valueOf(session.getAttribute("REAL_LOGGED_IN"));
           final String sessionMessage = String.valueOf(session.getAttribute("REAL_LOGGED_MESSAGE"));
           final String loggedInUser = String.valueOf(session.getAttribute("REAL_LOGGED_IN_USER"));
           %>

           Logged In Status: <span style="color:green"><%= loginFlag %></span>
           <br/>
           Post Auth Message: <span style="color:green"><%= sessionMessage %></span>
           <br/>
           WELCOME! <span style="color:green"><%= loggedInUser %></span>

           <h2>Application Links</h2>

           <p><a href="/badbanking/bank-home-servlet">Banking Accounts</a> - Your SECURED banking application</p>

           <p><a href="/badbanking/forum-home-servlet">BEMORY User Forum</a> - Student User Forum</p>

           <p><a href="/badbanking/bank-home-servlet">Secured Banking Accounts</a> - More Secure Banking Accounts</p>
